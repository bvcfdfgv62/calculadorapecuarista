...
// Lazy Load do pacote de gráficos (Recharts) para carregamento de página ultra rápido
            ...
            <>
                ...
                <div className="pt-4">
                    <React.Suspense fallback={
                        <div className="h-[280px] w-full rounded-[2.5rem] border border-dashed border-emerald-500/10 bg-emerald-500/[0.02] flex flex-col items-center justify-center gap-3">
                            <Loader2 className="w-8 h-8 text-emerald-500 animate-spin" />
                            <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/40">Carregando Inteligência Visual...</span>
                        </div>
                    }>
